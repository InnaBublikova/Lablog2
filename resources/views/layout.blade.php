            ...
            <div class="col-md-6">
                <aside class="footer-widget">
                    ...
                    <div class="about-content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy
                        eirmod tempor invidunt ut labore et dolore magna aliquyam erat...</div>     
                    <div class="address">
                        <h4 class="text-uppercase">Контактная информация</h4>

                        <p> 221B Will Street, London, GB</p>

                        <p> Phone: +123 456 78900</p>

                        <p>directclab@example.com</p>
                    </div>
                </aside>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2019 <a href="#">Blog, </a> Designed with <i
                            class="fa fa-heart"></i> by <a href="#">DC</a>
                    </div>
                </div>
            </div>
        </div>
