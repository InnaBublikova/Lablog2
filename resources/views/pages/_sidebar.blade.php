<div class="col-md-4" data-sticky_column>
                <div class="primary-sidebar">
                    ...
                    <aside class="widget news-letter">
                        <h3 class="widget-title text-uppercase text-center">Хотите узнавать новости первым?</h3>
                        @include('admin.errors')

                        <form action="/subscribe" method="post">
                        {{csrf_field()}}
                            <input type="email" placeholder="Введите ваш email" name="email">
                            <input type="submit" value="Подпишитесь сейчас"
                    ...
                    <aside class="widget">
                        <h3 class="widget-title text-uppercase text-center">Наши рекомендации</h3>
