        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <article class="post">
                    ...
                    <div class="post-content">
                        ...
                        <div class="social-share">
							<span
                                    class="social-share-title pull-left text-capitalize">Автор {{$post->author->name}} Дата {{$post->getDate()}}</span>
                ...
                <div class="top-comment"><!--top comment-->
                    <img src="{{$post->author->getAvatar()}}" style="padding: 0; margin-right:10px " class="pull-left img-circle" alt="" width="109" height="109" >
                    <h4> Об авторе: {{$post->author->name}}</h4>
                ...
                @if(Auth::check())
                    <div class="leave-comment"><!--leave comment-->
                        ...
                        <input type="hidden" name="post_id" value="{{$post->id}}">
                            ...
                            <button class="btn send-btn">Коментировать пост</button>
                        </form>
